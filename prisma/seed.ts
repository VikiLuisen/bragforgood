...
async function main() {
  ...
  const deed1 = await prisma.deed.create({
    data: {
      ...
      photoUrl: "https://images.unsplash.com/photo-1618477461853-cf6ed80faba5?w=800&q=80",
      isExample: true,
      authorId: anna.id,
  ...
  const deed4 = await prisma.deed.create({
    data: {
      ...
      photoUrl: "https://images.unsplash.com/photo-1526336024174-e58f5cdd8e13?w=800&q=80",
      isExample: true,
      authorId: sophie.id,
  ...
  const deed6 = await prisma.deed.create({
    data: {
      ...
      photoUrl: "https://images.unsplash.com/photo-1502904550040-7534597429ae?w=800&q=80",
      isExample: true,
      authorId: tom.id,
  ...
  const deed9 = await prisma.deed.create({
    data: {
      ...
      photoUrl: "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=800&q=80",
      isExample: true,
      authorId: anna.id,
  ...
  const deed12 = await prisma.deed.create({
    data: {
      ...
      photoUrl: "https://images.unsplash.com/photo-1491002052546-bf38f186af56?w=800&q=80",
      isExample: true,
      authorId: tom.id,
