...
async function main() {
  ...
  const deed1 = await prisma.deed.create({
    data: {
      ...
      photoUrl: "https://images.unsplash.com/photo-1758599669062-13f35df6b3ab?w=800&q=80",
      isExample: true,
      authorId: anna.id,
  ...
  const deed2 = await prisma.deed.create({
    data: {
      ...
      photoUrl: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=800&q=80",
      isExample: true,
      authorId: marco.id,
  ...
  const deed4 = await prisma.deed.create({
    data: {
      ...
      photoUrl: "https://images.unsplash.com/photo-1559235038-1b0fadf76f78?w=800&q=80",
      isExample: true,
      authorId: sophie.id,
  ...
  const deed5 = await prisma.deed.create({
    data: {
      ...
      photoUrl: "https://images.unsplash.com/photo-1568219557405-376e23e4f7cf?w=800&q=80",
      isExample: true,
      authorId: lisa.id,
  ...
  const deed6 = await prisma.deed.create({
    data: {
      ...
      photoUrl: "https://images.unsplash.com/photo-1702449414685-1ed9316b7253?w=800&q=80",
      isExample: true,
      authorId: tom.id,
  ...
  const deed7 = await prisma.deed.create({
    data: {
      ...
      photoUrl: "https://images.unsplash.com/photo-1762994576926-b8268190a2c9?w=800&q=80",
      isExample: true,
      authorId: lisa.id,
  ...
  const deed9 = await prisma.deed.create({
    data: {
      ...
      photoUrl: "https://images.unsplash.com/photo-1759422261399-3370e715b70f?w=800&q=80",
      isExample: true,
      authorId: anna.id,
  ...
  const deed11 = await prisma.deed.create({
    data: {
      ...
      photoUrl: "https://images.unsplash.com/photo-1683536816488-5cd8f78f7bbe?w=800&q=80",
      isExample: true,
      authorId: sophie.id,
  ...
  const deed12 = await prisma.deed.create({
    data: {
      ...
      photoUrl: "https://images.unsplash.com/photo-1483385573908-0a2108937c4a?w=800&q=80",
      isExample: true,
      authorId: tom.id,
